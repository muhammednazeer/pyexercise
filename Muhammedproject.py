...
defination = ''' What is Transition Metal?
...
print (defination)
print()
#List of General properties of transition metals
...
for counter in range(8):  #Loop to keep count of the number
    ...
    if properties == "X":
        ...
        print()
        break
    elif properties in trans_properties:
        print ()
...
# Dictionary data structure holding the list of transition metals and the properties
...
while True:  #While loop to continue requesting for user input until a user input quit
    ...
    if test == "Quit":
        ...
        break
    elif test in trans_Metal.keys(): #checking for the presence key in dictionary
        value = trans_Metal[test] #Grap the value of key
        for val in value: #Loop to print the properties in of element on a line
            print (val)
        print()
